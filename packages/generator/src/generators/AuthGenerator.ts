...
export class AuthGenerator extends BaseGenerator {
  run(): void {
    ...
    this.write('src/pages/Login.vue', this.render('shared/auth/client/Login.vue.hbs', data))
    this.write('src/pages/Register.vue', this.render('shared/auth/client/Register.vue.hbs', data))
  }
}
