...
export class AdminGenerator extends BaseGenerator {
  run(): void {
    ...
    for (const entity of adminEntities) {
      ...
      // Exclude the entity itself to avoid duplicate imports for self-referential relations
      // (e.g. `parent: Page` on the Page entity would otherwise import PageApi twice).
