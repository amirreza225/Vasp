...
export const Webhook = createToken({
  name: "Webhook",
  pattern: /webhook(?=\s)/,
});
export const Observability = createToken({
  name: "Observability",
  pattern: /observability(?=\s)/,
});
export const AutoPage = createToken({
  name: "AutoPage",
  pattern: /autoPage(?=\s)/,
});
...
export const Columns = createToken({
  name: "Columns",
  pattern: /columns(?=\s*\{)/,
});
export const Form = createToken({ name: "Form", pattern: /form(?=\s*\{)/ });
export const Sections = createToken({
  name: "Sections",
  pattern: /sections(?=\s*\{)/,
});
export const Steps = createToken({ name: "Steps", pattern: /steps(?=\s*\{)/ });
export const Permissions = createToken({
  name: "Permissions",
  pattern: /permissions(?=\s*\{)/,
});
export const Validate = createToken({
  name: "Validate",
  pattern: /validate(?=\s*\{)/,
});
...
export const Hidden = createToken({
  name: "Hidden",
  pattern: /hidden(?=\s*:)/,
});
export const Width = createToken({ name: "Width", pattern: /width(?=\s*:)/ });
export const Paginate = createToken({
  name: "Paginate",
  pattern: /paginate(?=\s*:)/,
});
export const Sortable = createToken({
  name: "Sortable",
  pattern: /sortable(?=\s*:|\s*\[)/,
});
export const Filterable = createToken({
  name: "Filterable",
  pattern: /filterable(?=\s*:|\s*\[)/,
});
export const Search = createToken({
  name: "Search",
  pattern: /search(?=\s*:|\s*\[)/,
});
export const Required = createToken({
  name: "Required",
  pattern: /required(?=\s*:)/,
});
export const MinLength = createToken({
  name: "MinLength",
  pattern: /minLength(?=\s*:)/,
});
export const MaxLength = createToken({
  name: "MaxLength",
  pattern: /maxLength(?=\s*:)/,
});
...
export const FloatType = createToken({
  name: "FloatType",
  pattern: /Float(?!\w)/,
});
...
export const JsonType = createToken({
  name: "JsonType",
  pattern: /Json(?!\w)/,
});
...
export const RedisStreams = createToken({
  name: "RedisStreams",
  pattern: /RedisStreams/,
});
