...
export const MAX_BYTES = parseMaxSize('50mb')

/** MIME type patterns allowed for upload (supports wildcards like image/*) */
export const ALLOWED_TYPES: string[] = ['image/jpeg', 'image/png', 'image/gif', 'image/webp', 'application/pdf', 'application/zip', 'text/plain', 'text/markdown', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet']
