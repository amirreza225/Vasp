<script setup>
// Profile — auto-scaffolded by Vasp. Customize freely.
...
<template>
  <div class="p-6 max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
      <h1 class="text-3xl font-bold m-0">Profile</h1>
    </div>
    ...
    <div class="card p-8 border border-surface rounded-xl shadow-sm text-center">
      ...
      <p class="text-surface-400 text-sm">
        Edit <code class="bg-surface-100 dark:bg-surface-800 px-1.5 py-0.5 rounded font-mono text-xs">src/pages/Profile.vue</code> to build your UI.
      </p>
    </div>
  </div>
</template>
