<script setup>
// Dashboard — auto-scaffolded by Vasp. Customize freely.
  ...
  <div class="p-6 max-w-4xl mx-auto">
    ...
    <div class="card p-8 border border-surface rounded-xl shadow-sm text-center">
      ...
      <p class="text-surface-400 text-sm">
        Edit <code class="bg-surface-100 dark:bg-surface-800 px-1.5 py-0.5 rounded font-mono text-xs">src/pages/Dashboard.vue</code> to build your UI.
      </p>
    </div>
  </div>
</template>
