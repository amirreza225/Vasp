    ...
    >
      <template #header>
        <div class="vasp-admin-table-header">
          <h2 class="vasp-admin-page-title">Space Management</h2>
          <div class="vasp-admin-table-actions">
            ...
            <Button icon="pi pi-plus" label="Add Space" @click="openCreate" />
          </div>
        </div>
      </template>
      ...
      <Column field="key" header="Key" sortable style="min-width: 8rem">
      </Column>
      <Column field="description" header="Description" sortable style="min-width: 8rem">
      </Column>
      <Column field="iconUrl" header="IconUrl" sortable style="min-width: 8rem">
      </Column>
      <Column field="isPublic" header="IsPublic" sortable style="min-width: 8rem">
        <template #body="{ data: row }">
          <i :class="row.isPublic ? 'pi pi-check text-green-500' : 'pi pi-times text-red-400'" />
        </template>
      </Column>
      ...
      <Column field="ownerId" header="User ID" style="min-width: 8rem" />
