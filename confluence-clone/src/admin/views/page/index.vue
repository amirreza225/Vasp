    ...
    >
      <template #header>
        <div class="vasp-admin-table-header">
          <h2 class="vasp-admin-page-title">Page Management</h2>
          <div class="vasp-admin-table-actions">
            ...
            <Button icon="pi pi-plus" label="Add Page" @click="openCreate" />
          </div>
        </div>
      </template>
      ...
      <Column field="body" header="Body" sortable style="min-width: 8rem">
      </Column>
      <Column field="status" header="Status" sortable style="min-width: 8rem">
      </Column>
      <Column field="version" header="Version" sortable style="min-width: 8rem">
      </Column>
      <Column field="excerpt" header="Excerpt" sortable style="min-width: 8rem">
      </Column>
      <Column field="slug" header="Slug" sortable style="min-width: 8rem">
      </Column>
      <Column field="isFeatured" header="IsFeatured" sortable style="min-width: 8rem">
        <template #body="{ data: row }">
          <i :class="row.isFeatured ? 'pi pi-check text-green-500' : 'pi pi-times text-red-400'" />
        </template>
      </Column>
      <Column field="viewCount" header="ViewCount" sortable style="min-width: 8rem">
      </Column>
      ...
      <Column field="spaceId" header="Space ID" style="min-width: 8rem" />
      <Column field="authorId" header="User ID" style="min-width: 8rem" />
      <Column field="parentId" header="Page ID" style="min-width: 8rem" />
