    ...
    >
      <template #header>
        <div class="vasp-admin-table-header">
          <h2 class="vasp-admin-page-title">Label Management</h2>
          <div class="vasp-admin-table-actions">
            ...
            <Button icon="pi pi-plus" label="Add Label" @click="openCreate" />
          </div>
        </div>
      </template>
      ...
      <Column field="color" header="Color" sortable style="min-width: 8rem">
      </Column>
