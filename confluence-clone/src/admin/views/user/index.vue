    ...
    >
      <template #header>
        <div class="vasp-admin-table-header">
          <h2 class="vasp-admin-page-title">User Management</h2>
      ...
      <Column field="displayName" header="DisplayName" sortable style="min-width: 8rem">
      </Column>
      <Column field="bio" header="Bio" sortable style="min-width: 8rem">
      </Column>
      <Column field="avatar" header="Avatar" sortable style="min-width: 8rem">
      </Column>
      <Column field="isActive" header="IsActive" sortable style="min-width: 8rem">
        <template #body="{ data: row }">
          <i :class="row.isActive ? 'pi pi-check text-green-500' : 'pi pi-times text-red-400'" />
        </template>
      </Column>
