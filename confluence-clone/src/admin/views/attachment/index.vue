    ...
    >
      <template #header>
        <div class="vasp-admin-table-header">
          <h2 class="vasp-admin-page-title">Attachment Management</h2>
          <div class="vasp-admin-table-actions">
            ...
            <Button icon="pi pi-plus" label="Add Attachment" @click="openCreate" />
          </div>
        </div>
      </template>
      ...
      <Column field="filename" header="Filename" sortable style="min-width: 8rem">
      </Column>
      <Column field="mimeType" header="MimeType" sortable style="min-width: 8rem">
      </Column>
      <Column field="sizeBytes" header="SizeBytes" sortable style="min-width: 8rem">
      </Column>
      <Column field="url" header="Url" sortable style="min-width: 8rem">
      </Column>
      ...
      <Column field="uploadedById" header="User ID" style="min-width: 8rem" />
